...
class BeatmapProperties
{
    ...
    override fun toString(): String
    {
        ...
        return """
            ...
            Mode:$mode
            LetterboxInBreaks:${letterboxInBreaks.num()}
            StoryFireInFront:${storyFireInFront.num()}
            UseSkinSprites:${useSkinSprites.num()}
            AlwaysShowPlayfield:${alwaysShowPlayfield.num()}
            OverlayPosition:$overlayPosition
            SkinPreference:$skinPreference
            EpilepsyWarning:${epilepsyWarning.num()}
            CountdownOffset:$countdownOffset
            SpecialStyle:${specialStyle.num()}
            WidescreenStoryboard:${widescreenStoryboard.num()}
            SamplesMatchPlaybackRate:${samplesMatchPlaybackRate.num()}
            
            [Editor]
            Bookmarks:${bookmarks.joinToString(",")}
            ...
            SliderTickRate:$sliderTickRate""".trimIndent()
    }
}
